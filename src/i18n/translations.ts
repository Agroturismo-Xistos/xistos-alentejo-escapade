...
const pt: Dict = {
  ...
  house: {
    ...
    groups: [
      ...
      { title: "Apartamento", desc: "Casa completa para estadias mais longas, com cozinha e sala.", alts: ["Quarto do apartamento com nichos decorativos", "Cozinha do apartamento com ilha vermelha", "Quarto do apartamento com acesso ao exterior"] },
    ],
  },
  purpose: {
...
const en: Dict = {
  ...
  house: {
    ...
    groups: [
      ...
      { title: "Apartment", desc: "A full house for longer stays, with kitchen and living room.", alts: ["Apartment bedroom with decorative wall niches", "Apartment kitchen with red island", "Apartment bedroom with outdoor access"] },
    ],
  },
  purpose: {
